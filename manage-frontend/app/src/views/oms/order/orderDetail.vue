<template>
  <div class="detail-container">
    ...
    <el-card shadow="never" style="margin-top: 15px">
      ...
      <div class="table-layout">
        <el-row>
          <el-col :span="12" class="table-cell-title">商品合计</el-col>
          <el-col :span="12" class="table-cell-title">运费</el-col>
          <!-- <el-col :span="6" class="table-cell-title">优惠券</el-col>
          <el-col :span="6" class="table-cell-title">积分抵扣</el-col>-->
        </el-row>
        <el-row>
          <el-col :span="12" class="table-cell">￥{{order.totalAmount}}</el-col>
          <el-col :span="12" class="table-cell">￥{{order.freightAmount}}</el-col>
        ...
        <el-row>
          ...
          <el-col :span="12" class="table-cell-title">应付款金额</el-col>
        </el-row>
        <el-row>
    ...
    <logistics-dialog v-model="logisticsDialogVisible" :info="info"></logistics-dialog>
  </div>
</template>
<script>
import {
...
export default {
  ...
  data() {
    return {
      ...
      logisticsParams: null
    };
  },
  created() {
    this.id = this.list = this.$route.query.id;
    this.logisticsParams = {
      deliverySn: this.$route.query.deliverySn,
      phone: this.$route.query.phone,
      deliveryCompanyName: this.$route.query.deliveryCompanyName
    };
    getOrderDetail(this.id).then(response => {
      this.order = response.data;
      this.resolcePic(response.data.orderItemList);
    });
  },
  filters: {
    formatNull(value) {
  ...
  methods: {
    ...
    async getMsg() {
      let params = this.logisticsParams;
      let res = await getDeliveryMsg(params);
      if (res) {
        console.log(res);
        this.info = res.data;
