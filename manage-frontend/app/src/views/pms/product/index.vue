<template>
  <div class="app-container">
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <span>数据列表</span>
      <el-button class="btn-add" @click="$routerLink('/pms/addProduct','save')" size="mini">添加</el-button>
    </el-card>
        ...
        <el-table-column label="操作" width="160" align="center">
          <template slot-scope="scope">
            <p>
              ...
              <el-button
                size="mini"
                @click="$routerLink('/pms/updateProduct','edit',{ id: scope.row.id })"
              >编辑</el-button>
            </p>
            <p>
  ...
  methods: {
    ...
    handleBatchOperate() {
      if (this.operateType == null) {
        this.$warnMessage("请选择操作类型");
        return;
      }
      if (!this.batchStatus) {
        this.$warnMessage("请选择要操作的商品");
        return;
      }
