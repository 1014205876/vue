<template>
  <div class="login">
    <div class="header">
      <div class="logo">
        <img src="https://wx2.sinaimg.cn/thumbnail/005tX86ply1g9ofthiko2j30sx0swqa2.jpg" alt="zg_logo">
      </div>
    </div>
    <div class="content">
      <van-field placeholder="请输入账号" v-model="account" left-icon="contact" :error-message="phoneNumberError" />
      <!-- eye -->
      <van-field v-if="loginWay==='password'" placeholder="请输入密码" v-model="password" left-icon="lock" :type="passwordType">
      ...
      <div class="button-wrap">
        <van-button size="large" @click="handleLogin" type="info" color="#5d87f3" round="true">登录</van-button>
      </div>
      <div class="more-wrap">
